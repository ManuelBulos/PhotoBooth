...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="photobooth",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10photobooth11AEXMLParser")
...
SWIFT_CLASS("_TtC10photobooth11AppDelegate")
...
SWIFT_CLASS("_TtC10photobooth13CameraPreview")
@interface CameraPreview : NSView
...
@interface CameraPreview (SWIFT_EXTENSION(photobooth)) <AVCaptureVideoDataOutputSampleBufferDelegate>
- (void)captureOutput:(AVCaptureOutput * _Nonnull)output didOutputSampleBuffer:(CMSampleBufferRef _Nonnull)sampleBuffer fromConnection:(AVCaptureConnection * _Nonnull)connection;
@end


/// NSView with buttons for controlling the camera and a canvas
SWIFT_CLASS("_TtC10photobooth13CameraToolBar")
@interface CameraToolBar : NSView
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
- (void)updateConstraints;
- (nonnull instancetype)initWithFrame:(NSRect)frameRect SWIFT_UNAVAILABLE;
@end
...
SWIFT_CLASS("_TtC10photobooth6Canvas")
...
SWIFT_CLASS("_TtC10photobooth15ImageEditorView")
@interface ImageEditorView : NSView
...
SWIFT_CLASS("_TtC10photobooth18MainViewController")
